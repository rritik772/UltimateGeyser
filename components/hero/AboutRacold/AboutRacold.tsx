...
const AboutRacold = () => {
  return (
    <div className='sm:(grid-cols-1) lg:(grid-cols-2) grid justify-items-center content-center gap-10 bg-gray-100 py-10'>
        ...
        <section className='relative h-[500px] w-[750px]'>
