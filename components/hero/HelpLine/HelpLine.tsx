  ...
  return (
    <div className='flex justify-center py-10 flex-wrap gap-10'>
       <a href='tel:+91-9792979287' id="telephone">
        <section className='flex flex-col <md:w-86 md:w-96 p-10 items-center gap-3 border rounded-lg shadow'>
        ...
        <section className='flex flex-col <md:w-86 md:w-96 p-10 items-center gap-3 border rounded-lg shadow'>
            ...
            <span className='font-bold  tracking-wide mt-3 <md:text-2xl md:text-3xl'>info@willerhot.com</span>
        ...
        <section className='flex flex-col <md:w-86 md:w-[30rem] p-10 items-center gap-3 border rounded-lg shadow'>
            <i className='bi bi-shop text-8xl text-red-500'/>
            <span className='font-bold  tracking-wide mt-3 <md:text-xl md:text-3xl'>customer.care@willerhot.com</span>
